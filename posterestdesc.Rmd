...
|**Intervalos**|10. Para la media|**Debe contener**|              |  |   | 
|**de confianza (IC)**|11. Para la varianza|Enunciado y respuesta|  |   |
|**Para una muestra**|12. Para la proporción|procedimiento con editor de ecuaciones|  |   |
|___________|________|___________________|_________________|______________|
|          |13. Para la diferencia de medias|**Debe contener**| |   | 
|**IC para dos muestras**|14. Para la razón de varianzas|Enunciado y respuesta|      |       | 
||15.Para la diferencia de proporciones|procedimiento con editor de ecuaciones|      |       | 
|________________________|________|_________________|_________________|______________|
|**Pruebas de hipótesis (PH)**|16. Para la proporción|**Debe contener**|| |
|Usa editor de ecuaciones word |17. Para la diferencia de proporciones|Paso a paso visto en clase|           |  |    
