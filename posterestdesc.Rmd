...
||1. Boxplot|5|comparativo de los niveles de factor de DOS variables cualitativas con una variable cuantitativa (5 puntos) |comparativo de los niveles de factor de una variable cualitativa con dos variables cuantitativas (3 puntos) |de una sola variable cuantitativa sin comparar nada (1 punto)  |
