...
## Hay dos tipos fundamentales de datos
...
Hay unos datos llamados cuasi-experimentales, en los cuales el investigador puede llegar a tener cierto nivel de control, por ejemplo en estudios médicos con pacientes el investigador puede controlar variables tales como dosis, tipo tratamiento, pero no
puede decidir sobre quien será el paciente.
