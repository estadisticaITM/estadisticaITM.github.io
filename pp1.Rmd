...
Existe una gran cantidad de herramientas para realizar análisis exploratorios para datos univariables. 
El objetivo fundamental es **entender** la información que se dispone. 
...
- El éxito de la imputación se basa en el conocimiento del mecanismo que generó los valores perdidos.

- Datos Perdidos Completamente y al Azar (MCAR) Su ausencia no se debe a la presencia de las variables en el estudio. Un caso que muestra que esto puede no ser así es la tendencia que tienen ciertos segmentos poblacionales a no dar respuesta a encuestas.
