...
La desviación típica es un promedio de estas distancias entre los puntos y su media. 
...
1. $\Large d : \mathbb{R}^p×\mathbb{R}^p \seq \mathbb{R}^+$ → <+, es decir, dados dos puntos en el espacio de dimensión p su distancia
