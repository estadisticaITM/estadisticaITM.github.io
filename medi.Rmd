...
Mientras la ciencia **metrología** se ocupa de mantener y aumentar la precisión de las mediciones, en cualquier campo, por ejemplo
...
**Incertidumbre** Parámetro asociado al resultado de una medición que caracteriza la dispersión de los valores que podrían ser atribuidos al mensurando, (ISP, 2010)
...
La precisión de una medida se expresa mediante medidas de dispersión tales como la desviación típica, la varianza o el coeficiente de variación bajo las condiciones especificadas.
...
Para la cuantificación de las medidas la ISO (organización internacional de estandarización - International Standardisation Organisation) creo la guia para la expresión de la incertidumbre de las medidas. **(GUM)**, actualizada en el año 1995.
...
|:--------------:|:---------|:-----------:|
|     VIM       |Vocabulario internacional de metrología  0.002   |0.032% |
| GUM           |0.018     |0.238% |
