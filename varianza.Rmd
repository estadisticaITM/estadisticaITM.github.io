...
método de comparación de pares de medias que controla la tasa de error experimental, proporciona intervalos de confianza para las diferencias por pares. Este método puede usarse en diseños de bloques completos aleatorizados y diseños de bloques incompletos
...
b) Haga un análisis descriptivo de los datos. ¿Qué puede concluir de estos en cuanto al promedio de mejoramiento de la productividad? ¿La variabilidad dentro de cada nivel del gasto en investigación y desarrollo puede considerarse o noaproximadamente constante?
...
d) Realice la prueba de normalidad sobre los residuales
...
Dé una expresión general para el cálculo de los residuales. Analice los gráficos de residuales estudentizados y úselos para validar los supuestos del modelo. Así mismo use los resultados de la prueba de Bartlett y de Levene. Realice el teste de normalidad con base en residuales estudentizados.
e) Calcule intervalos de confianza del 95% para la mejora media de productividad para cada nivel de gasto en inversión ydesarrollo.
