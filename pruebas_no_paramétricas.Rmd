...
Gran parte de los modelos estadísticos consideran que las observaciones provienen de poblaciones normales. En muchas situaciones este supuesto no se cumple. Una alternativa a la no normalidad de los datos, es proceder a implementar pruebas no paramétricas.
...
## Prueba para otras distribuciones
...
$$H_0=\frac{\sigma^2_{inicio}}{\sigma^2_{final}}=1$$
$$H_0=\frac{\sigma^2_{inicio}}{\sigma^2_{final}}\neq1$$
