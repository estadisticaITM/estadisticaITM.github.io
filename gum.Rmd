...
Comparación entre el dispositivo de medición que se va a calibrar y otro de referencia trazable (BIPM). La incertidumbre viene dada como un **múltiplo específico de una desviación típica**, se obtiene del cociente entre el valor indicado y el factor multiplicador.
