...
Resultado de la combinación de las contribuciones de todas las fuentes de incertidumbre es igual a la raíz cuadrada positiva de las desviaciones estándar de otras magnitudes, ponderadas en función de la variación del resultado de medida con la variación de dichas magnitudes (GUM).

La incertidumbre típica combinada de y es $u_c(y)$, caracteriza la dispersión de los valores que podrían ser  atribuidos al mensurando Y.  se obtiene de las incertidumbres típicas de las estimaciones de entrada $x_1, x_2, ..., x_N$. 
