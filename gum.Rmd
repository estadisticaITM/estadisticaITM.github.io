...
una incertidumbre aleatoria se distribuye alrededor de un valor central que finalmente se espera coincida con el valor real, es decir, las fluctuaciones aleatorias en los valores medidos terminan compensándose.
...
$$u(reproducibilidad)=\frac{s}{\sqrt n}$$
...
- Es una de las incertidumbres más complejas de controlar, siempre generará que las medidas se encuentren alrededor del mismo valor erróneo, por lo que nunca se compensarán, provocando que el valor real y central no coincidan; 

- La incertidumbre de una corrección por efecto sistemático conocido puede
...
entre ellos se puede tener los errores de calibración y sesgos en los instrumentos, etc.
