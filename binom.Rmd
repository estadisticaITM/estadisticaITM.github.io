...
p es la probabilidad de éxito en un enasayo individual

q es la probabilidad de fracaso en un ensayo individual $q=1-p$
...
Las probabilidades se pueden encontrar mediante dos formas por calculadora o por tabla:
...
es letal para 20% de los peces que queden expuestos a la concentración durante 24 horas. Veinte peces se colocan en un tanque que contiene esta concentración del producto químico en agua.
...
- siendo asi la probabilidad p de sobrevivir es p=0.8, mientras que la probabilidad de no sobrevivir es q=0.2
...
$$P(x \geq 10)=1-p(x\leq 9)=\sum_{x=0}^9\displaystyle{20 \choose x}0.8^x 0.2^{20-x}$$
