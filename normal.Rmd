...
plot(x, hist, type="l", xlab="X", ylab="Densidad",
     ...
     lty = 1, lwd = 3, yaxs="i") 
polygon(c(x[x <= 1.37],1.37), c(dnorm(x[x <=1.37]),0), col="lightblue")
prob <- pnorm(1.37, 0,1)
...
**Ejemplo 5** 
$$P(Z>1.5)=1-P(x\leq 1.55)=1-0.9334=0.0666$$

```{r}

x <- pnorm(1.55, mean = 0, sd = 1, lower.tail = TRUE) # 0.0668072
...
```{r}
normal_area(mean = 0, sd = 1, lb = -1.8, ub = 0.42,
            acolor = rgb(0, 0, 1, alpha = 0.5))
