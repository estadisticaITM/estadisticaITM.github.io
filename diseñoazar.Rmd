...
e) Calcule intervalos de confianza del 95% para cada porcentaje de algodón
...
$$\Large H_0=\sum_{i=1}^tc_i\mu_i=0$$
$$\Large H_1=\sum_{i=1}^tc_i\mu_i\not=0$$

Las constantes de los contrastes para la hipótesis de nuestro ejemplo son: $\large c_1=c_2=1,$ y $\large c_3 = 0,  c_4 = c_5 = −1$
