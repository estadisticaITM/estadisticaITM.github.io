...
La v.a Poisson es discreta, cuenta los eventos durante un periodo de tiempo, calcula la probabilidad de que se produzca un número de eventos.Las preguntas clásicas de la distribución de Poisson son "¿cuántas personas llegarán a mi caja en la próxima hora?".

La v.a exponencial es continua, calcula las probabilidades del paso del tiempo, las preguntas clásicas de la distribución exponencial son "¿cuánto tiempo pasará hasta que llegue la siguiente persona?", o una variante, "¿cuánto tiempo permanecerá la persona una vez que haya llegado?".
