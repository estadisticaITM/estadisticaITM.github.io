...
La respuesta media es el valor promedio esperado de la variable respuesta Y para un valor dado de la variable explicativa X.

Es decir:

$$E(Y∣X=x)$$

se lee como: “el valor esperado (o promedio) de Y dado que X=x”.

En el modelo de regresión lineal simple:

$$Y=β_0+β_1X+ε$$

la respuesta media está dada por:

$$E(Y∣X=x)=β_0+β_1x$$

el error aleatorio ε tiene media cero.

**Ejemplo**

Sea  X = horas de estudio y Y = nota del examen, para X=5 horas se obtiene:

E(Y∣X=5)=3.8

significa que el promedio esperado de las notas de todos los estudiantes que estudian 5 horas es 3.8.

No significa que todos obtengan exactamente 3.8, porque existe variabilidad individual (el error aleatorio).
