...
datos <- read.csv(sep = ";",dec=".",header = TRUE,
  "https://github.com/estadisticaITM/estadisticaITM.github.io/blob/master/ejm.csv")
...
cor(datos[4:13])
chart.Correlation(datos[5:13], histogram = T, pch = 19,col=as.factor(datos$depresión))
