...
datos <- read.csv(sep = ";",dec=".",header = TRUE,
  "https://raw.githubusercontent.com/estadisticaITM/estadisticaITM.github.io/refs/heads/master/ejm.csv")
...
cor(datos[4:13])
chart.Correlation(datos[4:13], histogram = T, pch = 19,col=as.factor(datos$platform_usage))
