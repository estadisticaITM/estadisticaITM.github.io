---
title: "Distribuciones multivariantes"
...
En este gráfico se puede observar que la distribucíon normal bivariada cuando la correlación entre las variables x y Y es cero (ρ=0), la superficie dibuja la clásica campana de gauss, en la posición marcada por el vector de medias de la distribución.
...
Sea una muestra aleatoria $x_1,...,x_n$ de tamaño n, de variables aleatorias independientes e idénticamente distribuidas, tomada de una distribució con media $\mu$ y varianza $\sigma^2$, el media muestral de estas variables aleatorias está dado por:
...
$$\frac{1}{\sqrt n} \sum_{i=1}^n [X_i-\mu]=\sqrt n(\bar X_i-\mu)$$
