...
|______________|_______________|_________|_________________|___________|__________|
| |20. Ajuste de la recta de regresión lineal|3|Ajusta un modelo de regresión lineal multivariado con variables indicadoras y lo interpreta (3 pts)| Ajusta un modelo de regresión lineal simple (1 pts)|No ajusta ningún modelo|
|**Regresión multivariada**|21. validación de la significancia de los parametros estimados |3|escribe la prueba de hipotesis y construye el estadístico (3 pts)| ||
||22. test de carencia de ajuste |3|escribe la prueba de hipotesis, construye el estadístico (3 pts)| ||
...
| |24. graficas de comportamiento de residuales|3| grafica y analisis de comportamiento de residuales (3 pts)| solo grafica de residuales (1 pts)  |   |
|______________|_______________|_________|____________|___________|__________|
|Presentación del trabajo escrito |25| 3| 1. Portada 2.Introducción 3.Cada gráfica tiene su respectivo análisis 4. Bibliografía según normas APA 4. Conclusiones  |   |
|______________|_______________|_________|________________|___________|__________|
