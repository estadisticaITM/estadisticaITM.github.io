...
| |19. Ajuste de la recta de regresión lineal simple en excel|3|Ajusta un modelo de regresión lineal simple para cada uno de los factores y lo interpreta (3 pts)| Ajusta un modelo de regresión lineal simple (1 pts)|No ajusta ningún modelo|
|______________|_______________|_________|_________________|___________|__________|
