...
|______________|_______________|_________|_________________|___________|__________|
| |13.Matriz de correlaciones (MC) entre variables cuantitativas (VC) |3|MC entre VC con su respectivo análisis| | |
|Regresión lineal|14. Diagrama de dispersión (DD)|3|Contiene el DD discriminando con colores los niveles de una variable cualitativa, con la línea recta superpuesta, para cada uno de los niveles del factor (3 puntos)| Contiene el DD sin discriminar los niveles de una variable cualitativa, superpone una línea recta (1 puntos) |Contiene el DD sin línea recta superpuesta(0 punto)|
|Regresión multivariada|15. Ajuste de la recta de regresión lineal|3|Ajusta un modelo de regresión lineal multivariado con variables indicadoras y lo interpreta (3 pts)| Ajusta un modelo de regresión lineal simple (1 pts)|No ajusta ningún modelo|
|Regresión multivariada|16. validación de la significancia de los parametros estimados |3|escribe la prueba de hipotesis y construye el estadístico (3 pts)| ||
|Regresión multivariada|16. test de carencia de ajuste |3|escribe la prueba de hipotesis, construye el estadístico (3 pts)| ||
...
| |18. graficas de comportamiento de residuales|3| grafica y analisis de comportamiento de residuales (3 pts)| solo grafica de residuales (1 pts)  |   |
|______________|_______________|_________|____________|___________|__________|
|**Pruebas de hipótesis (PH)**|19.|3|Para una muestra| | | 
| |20. |3| Para dos muestras|  |    | 
|______________|_______________|_________|_________________|___________|__________|
