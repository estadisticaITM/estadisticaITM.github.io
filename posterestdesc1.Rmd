...
|______________|_______________|_________|_________________|___________|__________|
| |13.|3|Para la proporción | | | 
| |14. |3| Para la diferencia de proporciones|  |    | 
|**Pruebas de hipótesis (PH)** |15.Prueba de normalidad |3| Verifica la normalidad con la prueba de shapiro wilk en R sobre la variable respuesta, escribe la PH de normalidad (3 pts)| |No verifica normalidad|
| |16.Prueba chi-2, independencia de variables |3| construye una tabla de doble entrada entre 2 variables cualitativas , escribe prueba de hipotesisy verifica la independencia (3 pts)|construye una tabla de doble entrada entre 2 variables cualitativas (1 pto)|No lo hace|
|______________|_______________|_________|_________________|___________|__________|
| |17.Matriz de correlaciones (MC) entre variables cuantitativas (VC) |3|MC entre VC con su respectivo análisis| | |
|**Regresión lineal simple**|18. Diagrama de dispersión (DD) en excel|3|Contiene el DD discriminando con colores los niveles de una variable cualitativa, con la línea recta superpuesta, para cada uno de los niveles del factor (3 puntos)| Contiene el DD sin discriminar los niveles de una variable cualitativa, superpone una línea recta (1 puntos) |Contiene el DD sin línea recta superpuesta(0 punto)|
| |19. Ajuste de la recta de regresión lineal simple en excel|3|Ajusta un modelo de regresión lineal simple para cada uno de los factores, superpone la linea recta estimada sobre el grafico de dispersión y lo interpreta (3 pts)| Ajusta un modelo de regresión lineal simple (1 pts)|No ajusta ningún modelo|
|______________|_______________|_________|_________________|___________|__________|
| |20. Diagrama de dispersión discriminando con colores los niveles de una variable cualitativa superponiendo las lineas rectas estimadas del modelo de regresión con variables indicadoras (3 pts)|  |  |
| |21. Ajuste de la recta del modelo de  regresión lineal multivvariado, muestra la salida de R, escribe  y analiza las rectas de regresión (3 pts)||Ajusta un modelo de regresión lineal multivariado con variables indicadoras y lo interpreta (3 pts)| |No ajusta ningún modelo|
|**Regresión multivariada**|22. validación de la significancia de los parametros estimados, |3|escribe la prueba de hipotesis y construye el estadístico (3 pts)| ||
|______________|_______________|_________|________________|___________|__________|
| Validación de los supuestos de normalidad sobre residuales|23.Prueba de normalidad |4| Escribe la PH de normalidad sobre los residuales y la verifica con la prueba de shapiro wilk en R (3 pts)| Escribe la PH de normalidad sobre los residuales ó la verifica con la prueba de shapiro wilk en R|No verifica normalidad|
| |24.Prueba de varianza constante|3| |  |   |
| |25. graficas de comportamiento de residuales|3| grafica y analisis de comportamiento de residuales (3 pts)| solo grafica de residuales (1 pts)  |   |
|______________|_______________|_________|____________|___________|__________|
