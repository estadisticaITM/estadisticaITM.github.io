...
|**Pruebas no paramétricas**|17. Grafico densidad |incluye dos variables cualitativas y el analisis|de una sola variable cuantitativa con analisis|una sola variable cuantitativa sin analisis|
...
|**RLM**|27.Ecuaciones de regresión|A partir del modelo anterior, escriba la recta multivariada general, asi como las rectas ajustadas de cada uno de los niveles y las interpreta|||
|**En Rstudio**|28. **Diagrama de Dispersión (DD)** |DD discriminando con colores los niveles de una variable cualitativa, superpone las lineas rectas estimadas del modelo de regresión con variables indicadoras|||
|**RLM**|29. **Test lineal general**|A partir del ANOVA ajusta el test lineal general mediante la prueba F, para validar significancia de la regresión, escriba prueba de hipotesis y el estadístico|||
|**En Rstudio** |30. validación de la **significancia de los parametros estimados**|Escribe la prueba de hipotesis y construye el estadístico||
||31. **Test lineal general**|Escribe la prueba de hipotesis, construye el estadístico, muestra la salida de R||
