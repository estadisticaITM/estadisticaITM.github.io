...
|Regresión multivariada|8. Ajuste de la recta de regresión lineal|4|Ajusta un modelo de regresión lineal multivariado con variables indicadoras y lo interpreta(4 pts)| Ajusta un modelo de regresión lineal simple(3 pts)|No ajusta ningún modelo|
|Regresión multivariada|8. validación de la significancia del modelo (test de carencia de ajuste) y de los parametros estimados |4|escribe la prueba de hipotesis, xconstruye el estadístico (4 pts)| ||
| |9. Validación de los supuestos de normalidad sobre residuales|4| Escribe la PH de normalidad sobre los residuales y la verifica con la prueba de shapiro wilk en R  (4 pts)  | Escribe la PH de normalidad sobre los residuales ó la verifica con la prueba de shapiro wilk en R|No verifica normalidad|
| ||4|4 graficas de comportamiento de residuales |  |   |
|______________|_______________|_________|____________|___________|__________|
...
|______________|_______________|_________|_________________|___________|__________|
|Presentación del trabajo escrito |15  | 4| 1. Portada 2.Introducción 3.Cada gráfica tiene su respectivo análisis 4. Bibliografía según normas APA 4. Conclusiones  |   |
