...
|  |1. Boxplot|3|comparativo de los niveles de factor de una variable cualitativa con una cuantitativa (3 puntos) |de una sola variable cuantitativa sin comparar nada (1 punto)  |no lo hace|
...
|Regresión multivariada|8. Ajuste de la recta de regresión lineal|3|Ajusta un modelo de regresión lineal multivariado con variables indicadoras y lo interpreta (3 pts)| Ajusta un modelo de regresión lineal simple (1 pts)|No ajusta ningún modelo|
|Regresión multivariada|9. validación de la significancia de los parametros estimados |3|escribe la prueba de hipotesis y construye el estadístico (3 pts)| ||
|Regresión multivariada|10. test de carencia de ajuste |3|escribe la prueba de hipotesis, xconstruye el estadístico (3 pts)| ||
| Validación de los supuestos de normalidad sobre residuales|11.Prueba de normalidad |4| Escribe la PH de normalidad sobre los residuales y la verifica con la prueba de shapiro wilk en R (3 pts)| Escribe la PH de normalidad sobre los residuales ó la verifica con la prueba de shapiro wilk en R|No verifica normalidad|
| |12 graficas de comportamiento de residuales|3| grafica y analisis de comportamiento de residuales (3 pts)| solo grafica de residuales (1 pts)  |   |
|______________|_______________|_________|____________|___________|__________|
|Tamaño de muestra (TM)| 13|3| Estima un TM estratificado para los datos que está tratando (3 pts)| Estima un TM para población finita para los datos que está tratando (2 pto)|  Estima un TM para población infinita para los datos que está tratando (1 pto)      |
|______________|_______________|_________|_________________|___________|__________|
|Pruebas de hipótesis (PH)|14|3|Para una muestra| | | 
| |15 |3| Para dos muestras|  |    | 
|______________|_______________|_________|_________________|___________|__________|
|Intervalos de confianza (IC)|16 |3| Para una muestra|  |    | 
||17 |3| Para dos muestras|  |    | 
|______________|_______________|_________|_________________|___________|__________|
|Presentación del trabajo escrito |18  | 3| 1. Portada 2.Introducción 3.Cada gráfica tiene su respectivo análisis 4. Bibliografía según normas APA 4. Conclusiones  |   |
