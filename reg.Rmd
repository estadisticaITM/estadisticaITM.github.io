...
En el siguiente diagrama se ilustra la presión atmosférica en relación a latemperatura
...
## Antes de hacer un modelo de regresión lineal
 ...
 Se deben identificar observaciones extremas, alejadas hacia valores muy grandes o pequeños comparadas con el resto de valores, que puedan influenciar el ajuste de regresión.
