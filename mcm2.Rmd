...
Para la implementación del método monte carlo se requiere el uso de software, en el desarrollo de este curso se usará Rstudio, con diferentes librerías, que facilitan la estimación de la incertidumbre. 
