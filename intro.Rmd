...
### Métodos estocásticos Monte carlo simulación  

la simulación de Monte Carlo 

Presente en todos aquellos ámbitos en los que el comportamiento aleatorio desempeña un papel fundamental.
...
### Métodos no estocásticos  GUM

Utiliza métodos determinísticos de estadística frecuentista para la evaluación de de incertidumbre tipo A, y lleva a cabo la
evaluación de incertidumbres tipo B y la combinación de incertidumbres con el método Bayesiano de soluciones analíticas.
