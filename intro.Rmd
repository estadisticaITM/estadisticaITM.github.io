...
|Magnitud básica (SIQ)|Nombre (SI)|símbolo (SI)|Constante|Reseña|
|:-------:|:---------:|:-------:|:-------:|:-------------------------:|
|Longitud |Metro      |m     |c=299 792 458 m/s   |velocidad de la luz en el vacio|
|Masa     |Kilogramo  |kg    |$6.626 070 15 × 10^{−34}$  J⋅s| Constante de Planck|
|Tiempo   |Segundo    |s     |Δν Cs= 9 192 631 770  Hz|frecuencia de transición hiperfina del átomo del celsio Cs|
|Corriente eléctrica|Ampére|A|1,602 176 634 × $10^{−19}$   C|carga elemental|
|Temperatura termodinámica|kelvin|K|$1.380649×10^{−23} J/K$|Constante de Boltzmann|
|Cantidad de sustancia|mol    |mol |$N_a=6.022 140 76 × 10^23  mol^{−1}$|Constante de Avogadro|
|Intensidad Luminosa  |Candela| cd |$K_{cd}$=683 lm / W |Eficacia luminosa de Radiación de 540 THz|
...
- La densidad de masa es una magnitud derivada definida como el cociente entre una masa y un volumen

|Magnitud derivada|ISQ   |SI|
|:---------------:|:----:|:----:|
|Densidad: Cociente entre una masa y el volumen|$\rho=[M][L]^{-3}$|$\rho=[kg][m]^{-3}$|
|Fuerza: producto de la masa y la aceleración|$F=[M][L][T]^{-2}$|$F=[Kg][m][s]^{-2}$|
...
Lo que significa que la medición está entre 47.5 a 48.5 ml, a éste se le conoce
como intervalo de confianza de la medición y su tamaño es el doble de la
incertidumbre. Esto generalmente se aplica cuando se trata de aparatos de
medición tales como reglas, transportadores, balanzas, probetas, manómetros,
termómetros, etc
...
Si las q r se miden con incertidumbre ∆q y ∆r respectivamente y
si se utilizan para calcular la diferencia w = q − r entonces la incertidumbre
asociada a la variable w es la suma de las incertidumbres asociadas a q y a r , es
decir
∆w = ∆q + ∆r
...
13. ¿Qué es un outlier o punto atípico y como detectarlo?
