...
```{r out.width="100%", fig.align='center', echo=FALSE}
knitr::include_graphics("imagen/ltmc.png")
```
...
|:---------:|:------------------------------------------------------------------|
|    BIPM   | Oficina Internacional de Pesas y Medidas (BIPM) fue creada por la Convención del Metro, firmada en París el 20 de mayo de 1875 por diecisiete Estados, en la última sesión de la Conferencia Diplomática. Esta Convención fue modificada en 1921. |   
...
## La humanidad y la medición

El primer codo real fue definido como la longitud del antebrazo del Faraón, desde el codo hasta el extremo del dedo medio, teniendo la mano extendida La medida original fue transferida y materializada en granito negro En los lugares de construcción, los trabajadores poseían copias en granito o madera, siendo responsabilidad de los arquitectos su mantenimiento


EURAMET, «Metrología Abreviada,» 2008.pp 8

```{r out.width="100%", fig.align='center', echo=FALSE}
knitr::include_graphics("imagen/medi.png")
```


**Convención del metro**

Tratado internacional firmado el 20 de mayo de 1875 por 17 representantes de
17 naciones en París 

**Objetivos de la convención del metro**

- Coordinar la metrología Internacional

- Desarrollar un sistema métrico que provea mediciones con un alto nivel de
trazabilidad dentro del marco del sistema internacional (masa y longitud)

```{r out.width="100%", fig.align='center', echo=FALSE}
knitr::include_graphics("imagen/conven.png")
```
...
Conferencia General de Pesas y Medidas, (Conférence générale des poids et mesures)


- Es la autoridad suprema, es una reunión de los delegados de cada nación Se reúnen en Francia cada 4 años

- (1921) Se extiende a todas las mediciones de variables físicas

- (1960) Se establece es sistema Internacional de Unidades (SI)

**OFICINA INTERNACIONAL DE PESAS Y MEDIDAS (BIPM)**

Oficina Internacional de Pesas y Medidas (Bureau international des poids et measures

- Se encuentra en Sèvres, Francia

- Resguarda el prototipo internacional del kilogramo

- Provee servicios metrológicos al CGPM y CIPM

- Anfitrión de las reuniones tanto del CGPM como del CIPM

- En sus laboratorios laboran 60 personas

**COMITÉ INTERNACIONAL DE PESAS Y MEDIDAS (CIPM)**

Comité Internacional de Pesas y Medidas (Comité international des poids et
mesures)

**Objetivo** 

- Promover la uniformidad en las unidades de medida al rededor del mundo


- Es un cuerpo consultor de la CGPM,compuesto por 18 destacados metrólogos
de diferentes países, son electos por el CGPM

- Consta con 10 comités consultores


**Responsabildades CIPM**

1. Revisar el trabajo de la oficina internacional de Pesos y Medidas ( bajo la autorización de la CGPM

2. Revisar el trabajo metrológico realizado en conjunto por países pertenecientes a la convención del metro y coordinar las actividades entre especialistas en metrología

3. Preparar los reportes de los comités para las reuniones de la CGPM
