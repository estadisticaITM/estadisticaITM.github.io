...
```{r out.width="100%", fig.align='center', echo=FALSE}
knitr::include_graphics("imagen/magnitud.png")
```
 ...
 **Apreciación** es la menor variación de la medida que podemos registrar con dicho instrumento. En los instrumentos con escala, la apreciación es el valor entre dos divisiones consecutivas; por ejemplo una probeta de 25,0 mL tiene una apreciación de 0,5 mL.
 ...
 **Propagación de la incertidumbre**
 q y r se miden con incertidumbre ∆q y ∆r respectivamente 
 
 
 **En la suma y diferencia**

Si se utilizan para calcular la diferencia w = q − r o la suma  w = q + r entonces la incertidumbre asociada a la variable w es la suma de las incertidumbres asociadas a q y a r, es decir:
...
Si los valores de q y r se utilizan para calcular el producto w = qr ó el cociente W=q/r, entonces la incertidumbre asociada, está dada por:

$$∆w = |w|\left( \frac{∆q}{q} + \frac{∆r}{r}\right) $$
...
y la incertidumbre resultante es:
$$∆w = |w|\left( \frac{∆q}{q} + \frac{∆r}{r}\right) $$
$$∆w = |w|\left(0.2  + 2.8 \right) $$
