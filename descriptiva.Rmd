...
- cual es la nota total obtenida en la materia
...
6. La segunda columna de la tabla, para datos agrupados es la frecuencia absoluta(𝑓𝑖):
...
7. Se busca las otras columnas que corresponden a la Frecuencia absoluta acumulada, frecuencia relativa y frecuencia relativa acumulada

|intervalo|Límite inferior|Límite superior        |$x_i$|$f_i$|$F_i$|
|:-------:|:-------------:|:---------------------:|:------:|:-:|:--:|
|1        |  $[X_{min}$    |$L_{s1}=L_{inf1}+a)$  |$x_1$|$f_1$|$F_1=f1$|
|2    |[$L_{inf2}=L_{sup1}$|$L_{sup2}=L_{inf2}+a)$|$x_2$|$f_2$|$F_2=f_1+f_2$|
