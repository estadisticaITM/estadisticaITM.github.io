...
Tab2
kable(addmargins(prop.table(table(fuma))*100))
```
...
### Gráfico de líneas
Muestran tendencias a lo largo de un período de tiempo, para diferentes niveles de una variable cualitativa, por lo tanto se usan para hacer comparaciones.Por ejemplo el número de asesorías brindadas en siga para los estudiantes, en las diferentes asignaturas
...
Hay 35 valores distintos para esta variable y leer una tabla tan larga no es práctico. dplyr de hecho corta el resultado. Tendrías que usar alguna otra función como View() para ver toda la tabla.
Puede ser más interesante agrupar valores cercanos, como 4.3 y 4.4; esta agrupación resuelve el punto 1 también.
