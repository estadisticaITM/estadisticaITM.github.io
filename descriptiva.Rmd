...
Donde $X_i$ es cada una de las observaciones, $W_i$ es la ponderación de cada uno de ellos,$\sum_{i=1}^n w_i=1$
...
Permite establecer el grado de simetría que tiene una distribución Coeficiente de asimetría de Pearson relaciona la media y la moda de un conjunto de datos
