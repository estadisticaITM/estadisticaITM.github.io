...
|---------------------------------|----------|----------|------------------------|
|Variables aleatorias $Y_1, Y_2, . . . , Y_n$|$\sigma^2$|$\sigma^2$|$Z=\frac{y-\mu}{\sigma}$|
|Distribución muestral $\bar Y_i,$|$\sigma^2/n=\sigma^2_{\bar y }$|$\sigma_{\bar y }$|$Z=\frac{y-\mu}{\sigma/\sqrt n}$|
