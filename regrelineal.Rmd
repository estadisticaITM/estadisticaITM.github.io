...
|Mdlo 1 (Error total) $y=\beta_0+\beta_1x$|n-2|SSE|<b style = 'color : red;'> $MSE=\frac{SSE}{n-2}$||
...
- Las letras en color azul corresponde a la salida del anova(mdlo1)
 
- Las letras en color rojo corresponde a los valores estimados a partir de as anovas anteriores
