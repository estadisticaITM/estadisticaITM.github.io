...
|**Nombre**|       **Definición**|**Leverage**|
|:------|:----------------------:|:------------:|
|**Outlier**|Es un valor atípico, con un valor Y (variable dependiente) inusual o extremo, |Bajo o alto.|
|**Punto Influyente o de balanceo**| Punto que si se elimina del conjunto de datos, cambiaría los coeficientes (pendiente e intercepto) del modelo de regresión, la función de R que los estima es influence.measures(mod)| Alto| 
