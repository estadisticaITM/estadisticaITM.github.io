...
La tabla ANOVA arrojada por el software R compara dos modelos, y tiene dos componentes está dada por: 

|Fuente de variación|Grados de libertad|Suma de cuadrados|Medias cuadráticas|Estadístico|
|-------------------|------------------|:---------------:|------------------|-----------|
|Mdlo 1 $y=\beta_0+\beta_1x$|  n-2          |$SSR_1$   |MSR               |    $F_c$  |
|Mdlo 2 $Y_{ij}=\mu_j+\varepsilon_{ij}$|n-k |$SSR_2$   |MSE               |   0        |
|carencia de ajuste                      |k-2 |$SSLOF=SSR_1-SSR_2$  |MSLOF  |$F_0$      |




La tabla ANOVA arrojada por el software R compara dos modelos, y tiene dos componentes, la primera parte está dada por: 

|Fuente de variación|Grados de libertad|Suma de Cuadrados Residuales RSS|<b style = 'color : red;'>Media cuadrática MSR|<b style = 'color : red;'>valor F</b>|
|:-------------------------------------:|:----------------:|:------------------------------:|:--------------------------------------------:|:-----:|
|Mdlo 1 $y=\beta_0+\beta_1x$|  n-2       |$SSR_{lineal}$         |$MSR_{lineal}$|
|Mdlo 2 $Y_{ij}=\mu_j+\varepsilon_{ij}$|n-k|$SSR_{factor}$       |
|Falta de ajuste                       |k-2|$SS_{LackOfFit}=SSR_{lineal}−SSR_{factor}$|$F_0=\frac{MSLOF}{MSPE}$|


La segunda parte, habla de la componente de falta de ajuste, está dada por:

|Df |	Sum of Sq   |	F |	Pr(>F)|
|:-:|:-----------:|---|-------:|
|k-2|$SS_{LackOfFit}=SSR_{lineal}−SSR_{factor}$||
