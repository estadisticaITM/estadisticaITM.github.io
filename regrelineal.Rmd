...
```
## **Pruebas de hipotesis en el modelo de regresión**
...
$\Large H_1: \beta_i \not= 0$: el modelo de regresión es significativo
...
El IC para la pendiente es un rango de valores que estima la verdadera pendiente de la línea de regresión de la población con un cierto nivel de confianza. Se basa en la línea de regresión de la muestra, que es la línea de mejor ajuste que describe la relación entre la variable independiente (x) y la variable dependiente (y) en una muestra de datos. El IC para la pendiente refleja la variabilidad e incertidumbre de la línea de regresión de la muestra debido al error de muestreo.
