...
|-------------------|------------------|-----------------|------------------|-----------|
|Regresión          |1                 |SSR              |$MSR=\frac{SSR}{1}$|$F_c=\frac{MSR}{MSE}$|
|Error              |n-2               |SSE              |$MSE=\frac{SSE}{n-2}$|                  |
|carencia de ajuste |k-2               |SSLOF            |$MSLOF=\frac{SSLOF}{K-2}$|$F_0=\frac{MSLOF}{MSPE}$|
...
La tabla ANOVA arrojada por el software R compara los dos modelos, y estima el componente de carencia de ajuste: 
...
La tabla ANOVA arrojada por el software R se puede completar de la siguiente manera:


|Fuente de variación|Grados de libertad|Suma de Cuadrados Residuales |<b style = 'color : red;'>Media cuadrática MSR|valor F|Valor p  |
|:--------------------------------|:------------:|:------------------------------:|:------------------------:|:------:|:---------:|
